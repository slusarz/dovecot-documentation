...
Most useful for debugging authentication flow.`
	...
	auth_worker_request_finished: {
		root: 'auth',
		fields: {
			command: `Command received by auth worker.`,
			command_id: `Command ID received by auth worker (integer).`,
			error: `Error message (if request ended in error).`,
		},
...
| \`invalid_credentials\` | [[added,events_invalid_credentials_added]] Credentials contain control characters. |

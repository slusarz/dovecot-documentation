...
during [[link,migration,migration]], because Dovecot doesn't yet known which fields need
...
| `pop3.uidl` | [[link,pop3,POP3]] UIDL responses. This is useful especially if some of the UIDLs have been migrated from an old system or if [[setting,pop3_reuse_xuidl]] is used. Otherwise Dovecot generates the UIDL in a way that usually doesn't require cache. |

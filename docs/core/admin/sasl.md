...
SASL stands for "Simple [[link,authentication,Authentication]] and Security Layer". SASL itself is
...
IMAP, POP3, SMTP, and [[link,managesieve,ManageSieve]] protocols all have support for SASL.

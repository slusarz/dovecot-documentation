...
performance for accessing mails. For some [[link,mailbox_formats,mailbox formats]], such as [[link,sdbox,sdbox]]
and [[link,mdbox,mdbox]], the index files are part of the format itself. For details

...
.. dovecot_core:setting:: imapc_features
   ...
   .. dovecotchanged:: 2.4.0 Several features are now automatically
   ...
   **Features**
   ...
   ``no-acl``
     ...
     .. dovecotchanged:: 2.4.0 Earlier versions had an "acl" feature,
   ...
   ``no-delay-login``
     ...
     .. dovecotchanged:: 2.4.0 Earlier versions had a "delay-login"
   ...
   ``no-modseq``
     ...
     .. dovecotchanged:: 2.4.0 Earlier versions had a "modseq" feature,
                         which is now enabled by default.
   ...
   **Optimizations**
   ...
   ``no-fetch-bodystructure``
     ...
     .. dovecotchanged:: 2.4.0 Earlier versions had a
   ...
   ``no-fetch-headers``
     ...
     .. dovecotchanged:: 2.4.0 Earlier versions had a "fetch-headers"
                         feature, which is now enabled by default.
   ...
   ``no-fetch-size``
     ...
     .. dovecotchanged:: 2.4.0 Earlier versions had a "rfc822.size"
                         feature, which is now enabled by default.
   ...
   ``no-search``
     ...
     .. dovecotchanged:: 2.4.0 Earlier versions had a "search" feature,
                         which is now enabled by default.
